...
for s in matmul matmul_naiv elementwise reduce unary_fwd unary_bw transpose copy grad_accum opt_sgd opt_adam softmax_fwd softmax_bw ce_fwd ce_bw norm_fwd norm_bw reduce_axis broadcast reduce_max_bw gather scatter_add rope head_slice; do
