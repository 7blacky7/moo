...
EXTRA_HARNESSES=(
  ...
  # C2-WIN: plattformneutraler Pull-Zustandsautomat mit vollständig injizierten
  # Media-Foundation-/WASAPI-Operationen; läuft hardwarefrei auf jedem Host.
  "test_capture_windows_ops_asan.c|moo_capture.c moo_capture_pull.c moo_frame.c moo_tensor.c moo_tensor_ops.c moo_ki_gpu.c moo_autograd.c moo_memory.c moo_value.c moo_print.c moo_string.c moo_dict.c moo_list.c moo_ops.c|-lm"
