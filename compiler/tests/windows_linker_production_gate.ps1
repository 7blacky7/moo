...
function Invoke-P016WindowsLinkerProductionGate {
    ...
    $fixturesScript=Get-P016ProductionBoundSibling 'windows_linker_behavior_fixtures.ps1' 'f69f166ffb53b107251a8c2e9df3077521e7a0977ba66cdc2760acb9df28c5af'
    $selftest=Get-P016ProductionBoundSibling 'windows_linker_fixture_selftest.ps1' '42991e668e283805239efba748a6d3db639a30b3e4c031c14c8589c8eccdd54c'
    ...
    try {
        ...
        $document=[ordered]@{
            ...
            selftest_sha256='42991e668e283805239efba748a6d3db639a30b3e4c031c14c8589c8eccdd54c'
