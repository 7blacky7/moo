...
pub struct RuntimeBindings<'ctx> {
    ...
    pub moo_tensor_gradient_setzen: FunctionValue<'ctx>,
    ...
    pub moo_nn_schicht_attnres: FunctionValue<'ctx>,
    pub moo_nn_attnres: FunctionValue<'ctx>,
    pub moo_tensor_hadamard: FunctionValue<'ctx>,
    pub moo_tensor_hadamard_inv: FunctionValue<'ctx>,
    pub moo_quant_sign_jl: FunctionValue<'ctx>,
    pub moo_quant_jl_projektion: FunctionValue<'ctx>,
    pub moo_quant_sign_jl_skalarprodukt: FunctionValue<'ctx>,
    ...
    pub moo_ui_leinwand_on_maus_los: FunctionValue<'ctx>,
    pub moo_ui_leinwand_on_rad: FunctionValue<'ctx>,
    pub moo_ui_leinwand_on_taste: FunctionValue<'ctx>,
    pub moo_ui_leinwand_fokus_setze: FunctionValue<'ctx>,
    pub moo_ui_leinwand_on_fokus: FunctionValue<'ctx>,
    pub moo_ui_zeichne_rechteck_rund: FunctionValue<'ctx>,
    pub moo_ui_zeichne_clip_setze: FunctionValue<'ctx>,
    pub moo_ui_zeichne_clip_loesche: FunctionValue<'ctx>,
    pub moo_ui_fenster_cursor_setze: FunctionValue<'ctx>,
    pub moo_ui_fenster_drag_start: FunctionValue<'ctx>,
    pub moo_ui_fenster_resize_start: FunctionValue<'ctx>,
    pub moo_ui_fenster_minimiere: FunctionValue<'ctx>,
    pub moo_ui_fenster_maximiere_umschalten: FunctionValue<'ctx>,
    pub moo_ui_fenster_transparenz: FunctionValue<'ctx>,
    pub moo_ui_host_backend_name: FunctionValue<'ctx>,
    pub moo_ui_host_fenster: FunctionValue<'ctx>,
    pub moo_ui_host_zeige: FunctionValue<'ctx>,
    pub moo_ui_host_schliesse: FunctionValue<'ctx>,
    pub moo_ui_host_praesentiere: FunctionValue<'ctx>,
    pub moo_ui_host_input_callback: FunctionValue<'ctx>,
    pub moo_ui_host_laufen: FunctionValue<'ctx>,
    pub moo_ui_host_pump: FunctionValue<'ctx>,
    pub moo_ui_host_beenden: FunctionValue<'ctx>,
    pub moo_ui_host_drag_start: FunctionValue<'ctx>,
    pub moo_ui_host_resize_start: FunctionValue<'ctx>,
    pub moo_ui_host_minimiere: FunctionValue<'ctx>,
    pub moo_ui_host_maximiere: FunctionValue<'ctx>,
    pub moo_ui_host_fenster: FunctionValue<'ctx>,
    pub moo_ui_host_zeige: FunctionValue<'ctx>,
    pub moo_ui_host_schliessen: FunctionValue<'ctx>,
    pub moo_ui_host_praesentiere: FunctionValue<'ctx>,
    pub moo_ui_host_input_callback: FunctionValue<'ctx>,
    pub moo_ui_host_laufen: FunctionValue<'ctx>,
    pub moo_ui_host_pump: FunctionValue<'ctx>,
    ...
    pub moo_ui_host_resize_start: FunctionValue<'ctx>,
    pub moo_ui_host_minimiere: FunctionValue<'ctx>,
    pub moo_ui_host_maximiere_umschalten: FunctionValue<'ctx>,
    pub moo_ui_host_cursor_setze: FunctionValue<'ctx>,
    ...
    pub moo_tls_connect_timeout: FunctionValue<'ctx>,
    pub moo_tls_starttls: FunctionValue<'ctx>,
...
impl<'ctx> RuntimeBindings<'ctx> {
    pub fn declare(context: &'ctx Context, module: &Module<'ctx>) -> Self {
        ...
        Self {
            ...
            moo_tensor_gradient_setzen: decl_mv_mv!("moo_tensor_gradient_setzen", mv2),
            ...
            moo_nn_schicht_attnres: decl_mv_mv!("moo_nn_schicht_attnres", mv1),
            moo_nn_attnres: decl_mv_mv!("moo_nn_attnres", mv2),
            moo_tensor_hadamard: decl_mv_mv!("moo_tensor_hadamard", mv2),
            moo_tensor_hadamard_inv: decl_mv_mv!("moo_tensor_hadamard_inv", mv2),
            moo_quant_sign_jl: decl_mv_mv!("moo_quant_sign_jl", mv3),
            moo_quant_jl_projektion: decl_mv_mv!("moo_quant_jl_projektion", mv3),
            moo_quant_sign_jl_skalarprodukt: decl_mv_mv!("moo_quant_sign_jl_skalarprodukt", mv2),
            ...
            moo_ui_leinwand_on_maus_los: decl_mv_mv!("moo_ui_leinwand_on_maus_los", mv2),
            moo_ui_leinwand_on_rad: decl_mv_mv!("moo_ui_leinwand_on_rad", mv2),
            moo_ui_leinwand_on_taste: decl_mv_mv!("moo_ui_leinwand_on_taste", mv2),
            moo_ui_leinwand_fokus_setze: decl_mv_mv!("moo_ui_leinwand_fokus_setze", mv1),
            moo_ui_leinwand_on_fokus: decl_mv_mv!("moo_ui_leinwand_on_fokus", mv2),
            moo_ui_zeichne_rechteck_rund: decl_mv_mv!("moo_ui_zeichne_rechteck_rund", &[mv, mv, mv, mv, mv, mv, mv]),
            moo_ui_zeichne_clip_setze: decl_mv_mv!("moo_ui_zeichne_clip_setze", &[mv, mv, mv, mv, mv]),
            moo_ui_zeichne_clip_loesche: decl_mv_mv!("moo_ui_zeichne_clip_loesche", mv1),
            moo_ui_fenster_cursor_setze: decl_mv_mv!("moo_ui_fenster_cursor_setze", mv2),
            moo_ui_fenster_drag_start: decl_mv_mv!("moo_ui_fenster_drag_start", mv1),
            moo_ui_fenster_resize_start: decl_mv_mv!("moo_ui_fenster_resize_start", mv2),
            moo_ui_fenster_minimiere: decl_mv_mv!("moo_ui_fenster_minimiere", mv1),
            moo_ui_fenster_maximiere_umschalten: decl_mv_mv!("moo_ui_fenster_maximiere_umschalten", mv1),
            moo_ui_fenster_transparenz: decl_mv_mv!("moo_ui_fenster_transparenz", mv2),
            moo_ui_host_backend_name: decl_mv_mv!("moo_ui_host_backend_name", &[]),
            moo_ui_host_fenster: decl_mv_mv!("moo_ui_host_fenster", mv4),
            moo_ui_host_zeige: decl_mv_mv!("moo_ui_host_zeige", mv1),
            moo_ui_host_schliesse: decl_mv_mv!("moo_ui_host_schliesse", mv1),
            moo_ui_host_praesentiere: decl_mv_mv!("moo_ui_host_praesentiere", mv2),
            moo_ui_host_input_callback: decl_mv_mv!("moo_ui_host_input_callback", mv2),
            moo_ui_host_laufen: decl_mv_mv!("moo_ui_host_laufen", &[]),
            moo_ui_host_pump: decl_mv_mv!("moo_ui_host_pump", &[]),
            moo_ui_host_beenden: decl_mv_mv!("moo_ui_host_beenden", &[]),
            moo_ui_host_drag_start: decl_mv_mv!("moo_ui_host_drag_start", mv1),
            moo_ui_host_resize_start: decl_mv_mv!("moo_ui_host_resize_start", mv2),
            moo_ui_host_minimiere: decl_mv_mv!("moo_ui_host_minimiere", mv1),
            moo_ui_host_maximiere: decl_mv_mv!("moo_ui_host_maximiere", mv1),
            moo_ui_host_fenster: decl_mv_mv!("moo_ui_host_fenster", mv4),
            moo_ui_host_zeige: decl_mv_mv!("moo_ui_host_zeige", mv1),
            moo_ui_host_schliessen: decl_mv_mv!("moo_ui_host_schliessen", mv1),
            moo_ui_host_praesentiere: decl_mv_mv!("moo_ui_host_praesentiere", mv2),
            moo_ui_host_input_callback: decl_mv_mv!("moo_ui_host_input_callback", mv2),
            moo_ui_host_laufen: decl_mv_mv!("moo_ui_host_laufen", &[]),
            moo_ui_host_pump: decl_mv_mv!("moo_ui_host_pump", &[]),
            ...
            moo_ui_host_resize_start: decl_mv_mv!("moo_ui_host_resize_start", mv2),
            moo_ui_host_minimiere: decl_mv_mv!("moo_ui_host_minimiere", mv1),
            moo_ui_host_maximiere_umschalten: decl_mv_mv!("moo_ui_host_maximiere_umschalten", mv1),
            moo_ui_host_cursor_setze: decl_mv_mv!("moo_ui_host_cursor_setze", mv2),
            ...
            moo_tls_connect_timeout: decl_mv_mv!("moo_tls_connect_timeout", mv3),
            moo_tls_starttls: decl_mv_mv!("moo_tls_starttls", mv2),
