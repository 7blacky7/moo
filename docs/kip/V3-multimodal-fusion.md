...
- Audio: A1-|STFT| → als [frames,bins,1]-Tensor → gleicher V2-Conv-Stack (Wiederverwendung, eigene Gewichte).
...
- **V3b Audio-Adapter:** identische Gates auf Audio-Toy; Encoder-Code geteilt mit V3a (nur Gewichte/Frontend anders).
