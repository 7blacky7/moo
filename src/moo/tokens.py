...
KEYWORDS: dict[str, TokenType] = {
    ...
    "setze_variable": TokenType.SET,
    "zeige_auf_bildschirm": TokenType.SHOW,
    "wenn_bedingung": TokenType.IF,
    "sonst_alternative": TokenType.ELSE,
    "solange_wiederhole": TokenType.WHILE,
    "fuer_jedes": TokenType.FOR,
    "funktion_definiere": TokenType.FUNC,
    "gib_wert_zurück": TokenType.RETURN,
    "neue_klasse": TokenType.CLASS,
    "importiere_modul": TokenType.IMPORT,
    ...
    # Español
    "establecer": TokenType.SET,
    # KEIN "a" als TO — kollidiert mit Variable "a"
    "en": TokenType.IN,
    "si": TokenType.IF,
    "sino": TokenType.ELSE,
    "mientras": TokenType.WHILE,
    "para": TokenType.FOR,
    "funcion": TokenType.FUNC,
    "función": TokenType.FUNC,
    "retornar": TokenType.RETURN,
    "mostrar": TokenType.SHOW,
    "no": TokenType.NOT,
    "verdadero": TokenType.BOOLEAN,
    "falso": TokenType.BOOLEAN,
    "nulo": TokenType.NONE,
    "clase": TokenType.CLASS,
    "nuevo": TokenType.NEW,
    "intentar": TokenType.TRY,
    "capturar": TokenType.CATCH,
    "lanzar": TokenType.THROW,
    ...
    "como": TokenType.AS,
    "datos": TokenType.DATA,

    # Français
    "définir": TokenType.SET,
    "definir": TokenType.SET,
    "sinon": TokenType.ELSE,
    "tantque": TokenType.WHILE,
    "pour": TokenType.FOR,
    "fonction": TokenType.FUNC,
    ...
    "fırlat": TokenType.THROW,
    "dur": TokenType.BREAK,
    "devam": TokenType.CONTINUE,
    "sabit": TokenType.CONST,
    "içeaktar": TokenType.IMPORT,
    "dışaaktar": TokenType.EXPORT,
    "veri": TokenType.DATA,
}
...
BOOLEAN_VALUES: dict[str, bool] = {
    ...
    "verdadero": True, "falso": False,   # ES
    "vrai": True, "faux": False,         # FR
    "doğru": True, "yanlış": False,      # TR
}
